...
export default function Beranda() {
  return (
    <div className="w-full bg-[#FFFFFF]">
      <section className="px-4 sm:px-6 md:px-16 py-12 md:py-20 w-full max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-10 md:gap-12 relative overflow-hidden">
        <div className="absolute left-0 right-0 top-1/2 h-[1px] bg-[#E5E7EB] -z-10 hidden md:block"></div>

        <div className="w-full md:w-1/2 text-left space-y-6">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#1E2F4D] leading-tight">
            Laporkan Masalah
            <br />
            Kotamu dengan Mudah
          </h1>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 pt-2 w-full sm:w-auto">
            <Link
              to="/buat-laporan"
              className="bg-[#1E2F4D] text-[#FFFFFF] px-6 md:px-8 py-3 rounded-md font-semibold text-base md:text-lg hover:bg-[#243B63] transition-colors text-center"
            >
              Lapor Sekarang
            </Link>
            ...
            <Link
              to="/daftar-laporan"
              className="bg-[#FFFFFF] text-[#1E2F4D] border-2 border-[#1E2F4D] px-6 md:px-8 py-3 rounded-md font-semibold text-base md:text-lg hover:bg-[#E5E7EB] transition-colors text-center"
            >
              Lihat Laporan
            </Link>
            ...
            <Link
              to="/admin/login"
              className="inline-flex items-center justify-center gap-2 bg-[#F8FAFC] text-[#1E2F4D] border-2 border-[#E5E7EB] px-6 py-3 rounded-md font-semibold text-base md:text-lg hover:border-[#1E2F4D] transition-colors text-center"
            >
        ...
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
            <div className="bg-[#FFFFFF] border border-[#E5E7EB] p-8 rounded-[24px] shadow-sm hover:shadow-md transition-shadow flex items-start gap-5">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#1E2F4D] mb-2">
                  Lapor Kerusakan
                </h3>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between relative gap-10 md:gap-0">
            <div className="flex-1 flex flex-col items-center text-center z-10 px-4">
              <div className="relative mb-6">
                <div className="w-7 h-7 rounded-full bg-[#1E2F4D] text-white text-xs font-bold flex items-center justify-center absolute -top-2 -left-2 border-2 border-white z-20">
                  1
                </div>
              ...
              <h3 className="text-lg font-bold text-[#1E2F4D] mb-3">
                Kirim Laporan
              </h3>
      ...
      <section className="px-6 md:px-16 py-12 w-full bg-[#FFFFFF] mb-10">
        <div className="max-w-[1383px] min-h-[139px] py-8 mx-auto bg-[#E5E7EB] rounded-[24px] flex flex-col sm:flex-row flex-wrap items-center justify-around px-4 md:px-8 gap-8">
      ...
      <section
        id="tentang-kami"
        className="px-6 md:px-16 pb-24 pt-10 w-full bg-[#FFFFFF]"
      >
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="space-y-4 text-left">
            <h2 className="text-3xl font-bold text-[#1E2F4D]">
              Tentang Kami
            </h2>
