...
export default function DaftarLaporanAdmin() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#F8FAFC] font-sans relative overflow-hidden">
      
      <div className="w-full lg:w-[260px] bg-[#1E2F4D] text-white flex flex-col shrink-0">
        
        <div className="p-6 flex items-center justify-center lg:justify-start gap-3 mb-2 lg:mb-6">
          <Icon icon="lucide:atom" className="w-8 h-8 text-[#FFFFFF]" />
          <span className="text-xl font-bold">CitizenCare</span>
        </div>

        <nav className="flex flex-wrap lg:flex-col justify-center lg:justify-start px-4 gap-2 pb-4 lg:pb-0">
          ...
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-[#243B63]/50 rounded-xl font-medium transition-colors"
          >
        ...
        <div className="p-4 lg:mt-auto">
          <button
            ...
            className="w-full flex items-center justify-center lg:justify-start gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-[#243B63]/50 rounded-xl font-medium transition-colors"
          >
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end gap-4 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <input
              ...
              className="px-4 py-2.5 rounded-xl border border-[#E5E7EB] text-sm text-[#1E2F4D] focus:outline-none w-full sm:w-auto"
            />
            ...
            <div className="relative w-full sm:w-auto">
              <select
                ...
                className="w-full pl-4 pr-10 py-2.5 rounded-xl border border-[#E5E7EB] appearance-none outline-none focus:border-[#1E2F4D] text-[#1E2F4D] text-sm bg-white cursor-pointer font-medium shadow-sm"
              >
              ...
              <Icon
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4 pointer-events-none"
              />
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <NavLink
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-lg border border-[#E5E7EB] px-3 py-2 text-gray-600 hover:bg-[#1E2F4D] hover:text-white transition-all mx-auto shadow-sm"
                      >
                        <Icon
                          icon="lucide:eye"
                          className="w-4 h-4"
      ...
      {showSettings && (
        <div className="fixed inset-0 bg-[#1E2F4D]/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-[#FFFFFF] w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl">
